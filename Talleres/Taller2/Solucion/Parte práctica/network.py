...
LEER!!!:
Ejercicio basado en on Neural Networks and Deep Learning. M. Nielsen. (2018)
Por favor no mirar las soluciones en la fuente! Trate de hacerlas usted mismo.

Revise primero la estructura de los vectores y matrices generados.
Para cada función a realizar lea muy cuidadosamente la forma y el formato en 
el que se esperan los parámetros.

Puede usar cualquier librería de python que desee
...
class Network(object):
    ...
    def backprop(self, x, y):
        ...
        Observe bien que ``nabla_b`` y ``nabla_w`` se generan para cada 
        elemento del minibatch. Esta función debe llamarse una vez por cada elemento del 
        minilote. 
    ...
    def evaluate(self, test_data):   # TODO
